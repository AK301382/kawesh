...
async def get_account(
    ...
    if account.customer_id != current_customer.id:
        ...
        raise PermissionDeniedException(translate("errors.auth.access_denied_to_account", locale))
...
async def deactivate_account(
    ...
    if success:
        return {"message": translate("messages.success.data_updated", locale)}
    else:
        from app.core.exceptions import DatabaseException
        raise DatabaseException(translate("errors.database.operation_failed", locale))
...
async def delete_account(
    ...
    if success:
        return {"message": translate("messages.success.data_deleted", locale)}
    else:
        from app.core.exceptions import DatabaseException
        raise DatabaseException(translate("errors.database.operation_failed", locale))
