...
const CustomerRegistration = () => {
  ...
  const steps = [
    { id: 1, title: 'اطلاعات تماس', icon: User },
    { id: 2, title: 'ایجاد حساب', icon: Lock }
  ];
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      setError(err.message || 'خطایی در حین ثبت‌نام رخ داد');
    } finally {
      setLoading(false);
    }
  };
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 flex items-center justify-center p-4">
      <div className="w-full max-w-2xl">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          <div className="mb-6">
            <h2 className="text-2xl font-bold text-gray-900 mb-2">
              {currentStep === 1 && 'اطلاعات تماس شما'}
              {currentStep === 2 && 'ایجاد حساب کاربری'}
            </h2>
            <p className="text-gray-600">
              {currentStep === 1 && 'لطفاً اطلاعات تماس خود را وارد کنید'}
              {currentStep === 2 && 'یک رمز عبور امن برای حساب خود ایجاد کنید'}
            </p>
          </div>
            ...
            <div className="space-y-5">
              <div>
                ...
                <p className="mt-2 text-xs text-gray-600 bg-gray-50 p-2 rounded">
                  حداقل 8 کاراکتر شامل حروف بزرگ و کوچک انگلیسی و عدد
                </p>
              </div>
              <div>
                <label className="block text-sm font-semibold text-gray-800 mb-2">
          ...
          <div className="flex justify-between mt-8 gap-4">
            ...
            >
              {loading ? (
                ...
                <>
                  {currentStep === 2 ? 'ایجاد حساب' : 'ادامه'}
        ...
        <div className="mt-6 text-center text-sm text-gray-700 bg-gradient-to-r from-blue-50 to-purple-50 p-4 rounded-lg border border-blue-100">
          🎉 <span className="font-semibold">14 روز استفاده رایگان</span> - بدون نیاز به کارت اعتباری!
        </div>
      </div>
    </div>
  );
