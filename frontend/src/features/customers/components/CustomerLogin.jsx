  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        setError(result.message || 'ایمیل یا رمز عبور نامعتبر است');
      }
    } catch (err) {
      setError(err.message || 'ایمیل یا رمز عبور نامعتبر است');
    } finally {
      setLoading(false);
    }
  };
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 mt-2">به حساب کاربری خود وارد شوید</p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
          ...
          <div className="mt-6 mb-6 flex items-center gap-3">
            ...
            <span className="text-sm text-gray-500 font-medium">یا</span>
            <div className="flex-1 h-px bg-gray-200" />
          </div>
