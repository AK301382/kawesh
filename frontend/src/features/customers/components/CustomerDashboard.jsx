...
const CustomerDashboard = () => {
  ...
  const { user, getToken, logout, isCustomer } = useAuth();
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-lg font-semibold text-gray-900">{user?.company_name}</h1>
                <p className="text-xs text-gray-500">{user?.subscription_plan} plan</p>
              </div>
            </div>
