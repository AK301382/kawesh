      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400 mt-2">
            Showing {startIndex + 1}-{Math.min(endIndex, testimonials.length)} of {testimonials.length} testimonials
          </p>
        </div>
        ...
        <div className="flex items-center justify-center gap-4">
          ...
          <button
            ...
            className="p-3 rounded-full bg-blue-600 dark:bg-cyan-500 hover:bg-blue-700 dark:hover:bg-cyan-600 text-white transition-all duration-200 shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed"
          ...
          <div className="flex gap-2">
            {[...Array(totalPages)].map((_, index) => (
              <button
                ...
                data-testid={`testimonials-page-${index + 1}`}
              />
            ))}
          </div>
