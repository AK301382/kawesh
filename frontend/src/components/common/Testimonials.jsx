...
const Testimonials = () => {
  ...
  const itemsPerView = 3; // تعداد نظراتی که در هر لحظه نمایش داده می‌شوند
  const totalTestimonials = testimonials.length; // 18 نظر
  
  // State for fake review form
  ...
  // Auto-slide every 3 seconds - حرکت به سمت چپ (نظر بعدی)
  useEffect(() => {
