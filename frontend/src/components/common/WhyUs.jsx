  ...
  const reasons = [
    {
      ...
      description: 'Over 10 years of experience in software development with 500+ successful projects delivered',
    ...
    {
      icon: Zap,
      title: 'Fast Delivery & High Quality',
      description: 'Clean code, scalable architecture, and on-time project delivery guaranteed',
    ...
    },
    {
      ...
      description: 'Team of elite developers, designers, and digital consultants dedicated to your success',
    ...
    },
    {
      ...
      description: 'Bank-level security standards and robust infrastructure for complete data protection',
    ...
    },
    {
      ...
      description: 'Scalable solutions designed to grow seamlessly with your business needs',
    ...
    },
    {
      icon: Heart,
      title: '24/7 Support',
      description: 'Always available support team ready to address your needs anytime, anywhere',
    ...
    },
    {
      ...
      description: 'Focused on driving sales growth, improving user experience, and achieving business success',
    ...
    },
    {
      ...
      description: 'Best price-to-quality ratio in the market with transparent, honest pricing',
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16" data-testid="why-us-header">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-300">
            Reasons that make us the best choice for your project
          </p>
        </div>
